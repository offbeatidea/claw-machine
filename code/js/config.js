...
window.ConfigManager = {
    configDefinitions: [
        ...
        { id: 'pendulumGravity', label: '钟摆重力', group: '甩爪', min: 0.0, max: 20.0, step: 1.0, default: 9.0, unit: '', explanation: '爪子摆动时的重力强度。值越大摆动越快。注意：甩爪效果受爪子移动加速度影响。' },
        { id: 'pendulumDamping', label: '钟摆阻尼', group: '甩爪', min: 0.1, max: 100.0, step: 1.0, default: 3.0, unit: '', explanation: '爪子摆动的能量损耗。值越大摆动越快停止（0=永久摆动，100=立刻停止）。' },
        ...
        { id: 'dropChance', label: '掉落率', group: '娃娃掉落', min: 0, max: 100, step: 1, default: 10, unit: '%', explanation: '每次掉落检测时，娃娃从爪子中掉落的概率。' },

        // ========== 分组 4：反弹（依赖娃娃掉落）==========
        { id: 'bounceDamping', label: '反弹阻尼', group: '反弹', min: 0, max: 100, step: 1, default: 25, unit: '', explanation: '娃娃落地反弹时保留的能量百分比。值越大反弹越高（0=不反弹，100=完全弹性碰撞）。' },
        { id: 'maxBounces', label: '最大反弹次数', group: '反弹', min: 1, max: 10, step: 1, default: 3, unit: '次', explanation: '娃娃落地后最多反弹几次。达到上限后直接静止。' },

        // ========== 分组 5：其他（独立参数）==========
        { id: 'grabSuccessRate', label: '抓取成功率', group: '其他', min: 0, max: 100, step: 1, default: 80, unit: '%', explanation: '爪子尝试抓取时，成功抓住娃娃的概率。值越高越容易抓到。' },
        { id: 'strongGrabRate', label: '强抓几率', group: '其他', min: 0, max: 100, step: 1, default: 50, unit: '%', explanation: '抓取成功时，触发"强抓"（牢牢抓住不放）的概率。强抓时娃娃不会在移动中掉落。' },
